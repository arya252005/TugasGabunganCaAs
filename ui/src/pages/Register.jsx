...
const ROLES = ['Petani', 'Peneliti']

export default function RegisterForm({ onSubmit, loading, onSwitch }) {
  const [form, setForm]               = useState({ name: '', email: '', password: '', confirmPassword: '', role: 'Petani' })
  ...
  return (
    <form onSubmit={handleSubmit} noValidate>
      <div className="form-heading">
        ...
        <p>Mulai pantau kelembaban tanah Anda</p>
      </div>
      ...
      <div className="field">
        ...
        <div className="field-wrap">
          ...
          <button type="button" className="field-eye" onClick={() => setShowPass(v => !v)}>
            {showPass ? <IconEyeClosed style={{ width: 16, height: 16 }}/> : <IconEyeOpen style={{ width: 16, height: 16 }}/>}
          </button>
        </div>
      ...
      <div className="field">
        ...
        <div className="field-wrap">
          ...
          <button type="button" className="field-eye" onClick={() => setShowConfirm(v => !v)}>
            {showConfirm ? <IconEyeClosed style={{ width: 16, height: 16 }}/> : <IconEyeOpen style={{ width: 16, height: 16 }}/>}
          </button>
        </div>
